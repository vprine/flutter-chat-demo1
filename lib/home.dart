...
class HomeScreen extends StatefulWidget {
  ...
  HomeScreen({Key key, @required this.currentUserId, @required this.todo})
      : super(key: key);

  @override
  State createState() =>
      HomeScreenState(currentUserId: currentUserId, todo: todo);
}

class HomeScreenState extends State<HomeScreen> {
  final Todo todo;
  HomeScreenState({Key key, @required this.currentUserId, @required this.todo});
            ...
            Container(
              child: StreamBuilder(
                stream: FirebaseFirestore.instance
                    .collection('users')
                    .where('nickname', isGreaterThan: todo.title)
                    .limit(_limit)
                    .snapshots(),
